...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TaiKhoan>(entity =>
        {
            ...
            entity.HasIndex(e => e.sEmail).IsUnique();

            entity.Property(e => e.bTrangThaiHoatDong).HasDefaultValue(true);
        ...
        modelBuilder.Entity<NganhNghe>(entity =>
        {
            ...
            entity.HasIndex(e => e.sTenLinhVuc).IsUnique();
        });
        ...
        modelBuilder.Entity<KhuVuc>(entity =>
        {
            ...
            entity.HasIndex(e => e.sTenKhuVuc).IsUnique();
        });
        ...
        modelBuilder.Entity<LuuTin>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.FK_IdSinhVien, e.FK_IdBaiTuyenDung }).IsUnique();
